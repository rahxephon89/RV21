#ifndef MapArch_FILE_H
#define MapArch_FILE_H
...
typedef enum {
    ...
    SYSCHANNEL_ch5,
    SYSCHANNEL_ch3,
    SYSCHANNEL_CreateMCI_violation,
} ChannelID;
...
int enqueue_CreateMCI_violation(SMEDLValue *identities, SMEDLValue *params, void *aux);
