#ifndef Unsafe_FILE_H
#define Unsafe_FILE_H
...
typedef enum {
    ...
    SYSCHANNEL_ch3,
    SYSCHANNEL_ch4,
    SYSCHANNEL_CreateVec_violation,
} ChannelID;
...
int enqueue_CreateVec_violation(SMEDLValue *identities, SMEDLValue *params, void *aux);
